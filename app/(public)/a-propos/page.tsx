...
export default function AProposPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-12">
      {/* Banner Titre */}
      <div className="bg-[#0B1B33] text-white p-8 md:p-12 border-3 border-black rounded-xs shadow-[10px_10px_0px_0px_#556B2F] relative overflow-hidden">
        <span className="text-[10px] font-mono font-bold uppercase bg-[#FEF08A] text-[#0B1B33] px-3 py-1 rounded-xs border border-black">
          Histoire & Vision
        </span>
        <h1 className="text-3xl md:text-5xl font-black uppercase text-[#FEF08A] mt-3">
      ...
      {/* Profil Fondatrice */}
      <div className="bg-[#F4EBD9] border-3 border-[#0B1B33] p-6 md:p-10 rounded-xs shadow-[10px_10px_0px_0px_#0B1B33] grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
        {/* Photo Fondatrice */}
        <div className="md:col-span-5 relative">
          <div className="aspect-4/5 bg-[#0B1B33] border-3 border-black rounded-xs shadow-[8px_8px_0px_0px_#556B2F] overflow-hidden relative group">
            <Image
              ...
              priority
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#0B1B33] via-transparent to-transparent opacity-60" />
            <div className="absolute bottom-4 left-4 right-4 text-white">
              <span className="text-[10px] font-mono uppercase bg-[#FEF08A] text-[#0B1B33] font-black px-2 py-0.5 border border-black">
                Fondatrice & Chef
              </span>
        ...
        <div className="md:col-span-7 space-y-4">
          <div className="inline-flex items-center gap-2 text-xs font-mono font-bold text-[#556B2F]">
            <GraduationCap className="w-5 h-5" /> <span>L'Âme Gastronomique de Cook'Tail</span>
          </div>

          <h2 className="text-2xl md:text-3xl font-black text-[#0B1B33] uppercase leading-tight">
          ...
          <div className="pt-2 grid grid-cols-2 gap-4 border-t-2 border-dashed border-[#0B1B33]">
            <div className="p-3 bg-white border border-black rounded-xs">
              <span className="text-xl font-black text-[#0B1B33]">5+ Ans</span>
              <span className="text-[10px] font-mono block text-gray-600 uppercase">D'Excellence Service</span>
            </div>
            <div className="p-3 bg-[#FEF08A] border border-black rounded-xs">
              <span className="text-xl font-black text-[#0B1B33]">100%</span>
      ...
      <div className="space-y-6">
        <h2 className="text-2xl font-black text-[#0B1B33] uppercase text-center flex items-center justify-center gap-2">
          <BookOpen className="w-6 h-6 text-[#556B2F]" /> Les Grandes Étapes de Cook'Tail
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {etapes.map((item, idx) => {
            ...
            return (
              <div
                key={idx}
                className="bg-white border-3 border-[#0B1B33] p-6 rounded-xs shadow-[6px_6px_0px_0px_#0B1B33] space-y-3 relative"
              >
                <div className="flex items-center justify-between">
                  <span className="text-xs font-mono font-black bg-[#556B2F] text-white px-2.5 py-1 rounded-xs border border-black">
                    {item.year}
                  </span>
                  <div className="w-10 h-10 bg-[#FEF08A] border border-black rounded-xs flex items-center justify-center text-[#0B1B33]">
                    <Icon className="w-5 h-5" />
                  </div>
                </div>

                <h3 className="text-lg font-black text-[#0B1B33] uppercase">{item.title}</h3>
      ...
      {/* Call to Action */}
      <div className="bg-[#FEF08A] border-3 border-[#0B1B33] p-8 rounded-xs shadow-[8px_8px_0px_0px_#0B1B33] text-center space-y-4">
        <h3 className="text-2xl font-black text-[#0B1B33] uppercase">Envie de Célébrer avec Nous ?</h3>
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
          <Link
            href="/reservation"
            className="bg-[#0B1B33] text-white font-black px-6 py-3.5 rounded-xs border-2 border-black text-xs uppercase tracking-wider shadow-[4px_4px_0px_0px_#556B2F]"
          >
            Réserver mon Pass Élève
          </Link>
          <Link
            href="/contact"
            className="bg-white text-[#0B1B33] font-black px-6 py-3.5 rounded-xs border-2 border-black text-xs uppercase tracking-wider shadow-[4px_4px_0px_0px_#0B1B33]"
          >
