      ...
      <div className="flex items-center gap-3">
        <div className="relative hidden sm:block">
          ...
          <input
            ...
            className="pl-9 pr-4 py-1.5 bg-white/10 border-2 border-white/20 rounded-xs text-xs font-mono text-white placeholder-gray-400 focus:outline-none focus:border-[#FEF08A] transition-all w-64 md:w-80"
          />
        </div>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative">
          <button
            ...
            className="relative p-2 bg-[#F4EBD9] text-[#0B1B33] border-2 border-black rounded-xs shadow-[2px_2px_0px_0px_#FEF08A] hover:translate-x-0.5 hover:translate-y-0.5 transition-all"
